...
{
    public class ExersiceRepository : Repository, Repository<Exersice_Model>
    {
        ...
        {
            string sql = $@"Insert into Exersice(Exersice_Name)";
        ...
        {
            string sql = $@"Delete from Exersice where Exersice_ID = @Exersice_ID";
        ...
        {
            string sql = $@"select * from Exersice where Exersice_ID = @Exersice_ID";
            base.dbContext.AddParameters("@Exersice_ID", id);
        ...
        public IEnumerable<Exersice_Model> GetAll()
        {
            ...
            string sql = $@"select * from Exersice";
