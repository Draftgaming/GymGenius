...
{
    public class MachinesRepository : Repository, Repository<Machines_Model>
    {
        ...
        {
            string sql = $@"Insert into Machines(Machine_Name, Machine_Description, Machine_Image)
        ...
        {
            string sql = $@"Delete from Machines where Machine_ID = @Machine_ID";
        ...
        {
            string sql = $@"select * from Machines where Machine_ID = @Machine_ID";
            base.dbContext.AddParameters("@Machine_ID", id);
