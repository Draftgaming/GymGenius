...
{
    public class MusclesRepository : Repository, Repository<Muscles_Model>
    {
        ...
        {
            string sql = $@"Insert into Muscles(Muscles_Name, Muscles_Description);
        ...
        {
            string sql = $@"Delete from Muscles where Muscles_ID = @Muscles_ID";
        ...
        {
            string sql = $@"select * from Muscles where Muscles_ID = @Muscles_ID";
            base.dbContext.AddParameters("@Muscles_ID", id);
