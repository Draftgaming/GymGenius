...
{
    public class CoachRepository : Repository, IRepository<Coach_Model>
    {
        ...
        {
            string sql = $@"Insert into Coach_Model(Coach_Name) values(@Coach_Name)";
        ...
        {
            string sql = $@"Update Coach_Model set Coach_Name = @Coach_Name where Coach_ID = @Coach_ID";
        ...
        {
            string sql = $@"Delete from Coach_Model where Coach_ID = @Coach_ID";
        ...
        {
            string sql = $@"select * from Coach_Model where Coach_ID = @Coach_ID";
            base.dbContext.AddParameters("@Coach_ID", id);
        ...
        public IEnumerable<Coach_Model> GetAll()
        {
            ...
            string sql = $@"select * from Coach_Model";
